...
{
	bool result;
	//Store the screen sizeand the base view matrix, these will be used for rendering 2D text.
	...
	//Createand initialize the font object.
	...
	//Createand initialize the font shader object.
	...
	//Createand initialize the two strings that will be used for this tutorial.One string says Hello in white at 100, 100 and the other says Goodbye in yellow at 100, 200. The UpdateSentence function can be called to change the contents, location, and color of the strings at any time.
	...
	ID3D11DeviceContext* deviceContext)
{
	...
	//Set the colorand size of the sentence.
	...
	//Build the vertex array using the FontClassand the sentence information.
