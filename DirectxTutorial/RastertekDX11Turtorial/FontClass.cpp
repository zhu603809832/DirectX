...
bool FontClass::LoadFontData(const char* filename)
{
	...
	//Now we open the fileand read each line into the array m_Font.We only need to read in the texture TU leftand right coordinates as well as the pixel size of the character.
